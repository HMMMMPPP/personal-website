...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    client.release();
    console.log(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] Successfully added suggestion: ${name}`);
    return {
      statusCode: 201,
      // Created
      headers: {
    ...
    console.error(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] API Error in POST /api/suggestions function:`, error.message);
    return {
      statusCode: 500,
      headers: {
        "Content-Type": "application/json",
...
//# sourceMappingURL=api-suggestions.js.map
