...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    if (event.httpMethod === "POST") {
      ...
      client.release();
      console.log(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] Successfully added contact message: ${name}`);
      return {
        statusCode: 201,
        // Created
        headers: {
      ...
      client.release();
      console.log(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] Successfully sent ContactUs data.`);
      return {
        statusCode: 200,
        headers: {
          "Content-Type": "application/json",
    ...
    console.error(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] API Error in /api/contact function (${event.httpMethod}):`, error.message);
    return {
      statusCode: 500,
      headers: {
        "Content-Type": "application/json",
...
//# sourceMappingURL=api-contact.js.map
