...
exports.handler = async function(event, context) {
  if (event.httpMethod !== "GET") {
    return {
      ...
      headers: {
        ...
        // Allow all origins for simplicity, tighten in production if needed
  ...
  try {
    ...
    const allSupportersData = topTierRes.rows.map((row) => ({
      ...
      amount: parseFloat(row.donated_amount) || 0,
      // Handle potential NULL donated_amount
      message: row.message || ""
    ...
    const missionData = {
      goal: 1e6,
      // Static data from your server.js
      parts: [
        // Static data from your server.js
        { id: "cockpit", name: "Cockpit & Avionics", cost: 1e5 },
        { id: "fuselage", name: "Fuselage & Structure", cost: 25e4 },
        { id: "wings", name: "Wing Assembly", cost: 5e5 },
        { id: "engines", name: "Propulsion Systems", cost: 75e4 },
        { id: "tail", name: "Control Surfaces", cost: 1e6 }
      ],
      logbook: logbookData,
      ...
      contactusData
      // Including this as your getNeonData() also fetched it
    };
    return {
      statusCode: 200,
      headers: {
    ...
    console.error(`[${(/* @__PURE__ */ new Date()).toLocaleTimeString("en-PH", { timeZone: "Asia/Manila" })}] API Error in /api/data function:`, error.message);
    return {
      statusCode: 500,
      headers: {
        "Content-Type": "application/json",
